...
public class C_TridentIntakeNeutral extends Command {
    ...
    public C_TridentIntakeNeutral(MantaRay incomingss_Trident,double _dutycycleSpeed)
    {
        dutycycleSpeed =_dutycycleSpeed;
        ss_Trident = incomingss_Trident;
        addRequirements(incomingss_Trident);
    }
    public C_TridentIntakeNeutral(MantaRay incomingss_Trident){
        ss_Trident = incomingss_Trident;
        addRequirements(incomingss_Trident);
    }
