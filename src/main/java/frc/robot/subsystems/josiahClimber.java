...
public class josiahClimber extends SubsystemBase {
  ...
  public final TalonFX m_CatchMotor = new TalonFX(constants.CanBus.CanBusIDs.josiahClimberCatchMotorCanID.id, constants.CanBus.CanivoreCANBusName);
  public final TalonFX m_SlideMotor = new TalonFX(constants.CanBus.CanBusIDs.josiahClimberSlideCanID.id, constants.CanBus.CanivoreCANBusName);
